...
public class IabHelper {
	 ...
	 *            Your application's public key, encoded in base64. This is used for verification of purchase
	 *            signatures. You can find your app's base64-encoded public key in your application's page on Google
	 *            Play Developer Console. Note that this is NOT your "developer public key".
	 */
	 ...
	 * @param extraData
	 *            Extra data (developer payload), which will be returned with the purchase data when the purchase
	 ...
	 */
	public void launchPurchaseFlow(Activity act, String sku, String itemType, int requestCode, OnIabPurchaseFinishedListener listener,
			String extraData) {
		checkNotDisposed();
	 ...
	 * @param moreItemSkus
	 *            additional PRODUCT skus to query information on, regardless of ownership. Ignored if null or if
	...
	public static String getResponseDesc(int code) {
		...
		String[] iabhelper_msgs = ("0:OK/-1001:Remote exception during initialization/" + "-1002:Bad response received/"
				...
				+ "-1006:Unknown purchase response/" + "-1007:Missing token/" + "-1008:Unknown error/" + "-1009:Subscriptions not available/"
	...
	void flagStartAsync(String operation) {
		if (mAsyncInProgress) {
			Log.e("IabHelper", "Can't start async operation (" + operation + ") because another async operation(" + mAsyncOperation
					+ ") is in progress.");
			return;
		}
