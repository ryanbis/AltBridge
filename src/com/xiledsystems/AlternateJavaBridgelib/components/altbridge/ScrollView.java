...
public class ScrollView implements Layout {
  ...
  ScrollView(Context context, int orientation, Integer null1, Integer null2, int resourceId) {
    ...
    layoutManager = null;
    // layoutManager = (android.widget.ScrollView)
  ...
  public void add(AndroidViewComponent component) {
    if (resourceId != -1) {
      ((android.widget.ScrollView) ((Form) context).findViewById(resourceId)).addView(component
          .getView(), new android.widget.LinearLayout.LayoutParams(
  ...
  public void remove(AndroidViewComponent component) {
    if (resourceId != -1) {
      ((android.widget.ScrollView) ((Form) context).findViewById(resourceId)).removeView(component
          .getView());
    } else {
