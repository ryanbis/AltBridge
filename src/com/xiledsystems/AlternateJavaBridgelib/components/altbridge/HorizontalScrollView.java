...
public class HorizontalScrollView implements Layout {
  ...
  HorizontalScrollView(Context context, int orientation, Integer null1, Integer null2,
      int resourceId) {
    this.context = context;
    this.resourceId = resourceId;
    layoutManager = null;
    // layoutManager = (android.widget.HorizontalScrollView)
  ...
  HorizontalScrollView(Context context, int orientation, final Integer preferredEmptyWidth,
    ...
    if (preferredEmptyWidth == null && preferredEmptyHeight != null || preferredEmptyWidth != null
        && preferredEmptyHeight == null) {
  ...
  public void add(AndroidViewComponent component) {
    if (resourceId != -1) {
      ((android.widget.HorizontalScrollView) ((Form) context).findViewById(resourceId)).addView(
          component.getView(), new android.widget.LinearLayout.LayoutParams(
  ...
  public void remove(AndroidViewComponent component) {
    if (resourceId != -1) {
      ((android.widget.HorizontalScrollView) ((Form) context).findViewById(resourceId))
