...
public final class PasswordTextBox extends AndroidViewComponent implements OnFocusChangeListener {
	...
	public PasswordTextBox(ComponentContainer container, int resourceId) {
		...
		view = (EditText) container.$context().findViewById(resourceId);
	...
	/**
	 * Returns the password textbox's background color as an
	...
	/**
	 * Specifies the password textbox's background color as an
	 * alpha-red-green-blue integer.
	 * 
	 * @param argb
	...
	/**
	 * Returns true if the password textbox's text should be bold. If bold has
	...
	/**
	 * Specifies whether the password textbox's text should be bold. Some fonts
	 * do not support bold.
	 * 
	 * @param bold
	...
	/**
	 * Returns true if the password textbox's text should be italic. If italic
	 * has been requested, this property will return true, even if the font does
	 * not support italic.
	 * 
	...
	/**
	 * Specifies whether the password textbox's text should be italic. Some
	 * fonts do not support italic.
	 * 
	 * @param italic
