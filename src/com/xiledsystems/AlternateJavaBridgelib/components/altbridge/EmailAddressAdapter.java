...
public class EmailAddressAdapter extends ResourceCursorAdapter {
  ...
  private static final String SORT_ORDER = ContactsContract.CommonDataKinds.Email.TIMES_CONTACTED + " DESC, " + ContactsContract.CommonDataKinds.Email.DISPLAY_NAME;
  ...
  public EmailAddressAdapter(Context context) {
    super(context, android.R.layout.simple_dropdown_item_1line, null, false);
  ...
  public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
    ...
    return contentResolver.query(ContactsContract.CommonDataKinds.Email.CONTENT_URI, PROJECTION,
