...
public abstract class TextBoxBase extends AndroidViewComponent implements OnFocusChangeListener {
	 ...
	 * 
	 * @param container
	 *            container that the component will be placed in
	 * @param textview
	 *            the underlying EditText object that maintains the text
	 */
	...
	/**
	 * Event raised when this component is selected for input, such as by the
	 * user touching it.
	 */
	...
	/**
	 * Event raised when this component is no longer selected for input, such as
	 * if the user touches a different text box.
	 */
	...
	/**
	 * Returns the alignment of the textbox's text: center, normal (e.g.,
	...
	/**
	 * Specifies the alignment of the textbox's text: center, normal (e.g.,
	 * left-justified if text is written left to right), or opposite (e.g.,
	 * right-justified if text is written left to right).
	 * 
	 * @param alignment
	...
	/**
	 * Returns true if the textbox's text should be bold. If bold has been
	...
	/**
	 * Specifies whether the textbox's text should be bold. Some fonts do not
	 * support bold.
	 * 
	 * @param bold
	...
	/**
	 * Returns true if the textbox's text should be italic. If italic has been
	 * requested, this property will return true, even if the font does not
	 * support italic.
	 * 
	...
	/**
	 * Specifies whether the textbox's text should be italic. Some fonts do not
	 * support italic.
	 * 
	 * @param italic
	...
	/**
	 * Returns the textbox's text's font face as default, serif, sans serif, or
	 * monospace.
	 * 
	...
	/**
	 * Specifies the textbox's text's font face as default, serif, sans serif,
	 * or monospace.
	 * 
	 * @param typeface
	...
	public void onFocusChange(View previouslyFocused, boolean gainFocus) {
		if (gainFocus) {
			...
			// TODO(user): this field stayed in TextBox. It isn't being used
			// yet,
