...
public final class CsvUtil {
	  ...
	  public static ArrayList<ArrayList<String>> fromCsvTable(String csvString)  {
	  ...
	  public static ArrayList<String> fromCsvRow(String csvString)  {
	    CsvParser csvParser = new CsvParser(new StringReader(csvString));
	    if (csvParser.hasNext()) {
	    	ArrayList<String> row = csvParser.next();
	      if (csvParser.hasNext()) {
	  ...
	  // TODO(user): do we want to enforce any consistency constraints here, e.g.,
	  // all rows have same number of elements?
	  public static String toCsvTable(ArrayList<ArrayList<String>> csvList) {
	    StringBuilder csvStringBuilder = new StringBuilder();
	    for (Object rowObj : csvList.toArray()) {
	      makeCsvRow((ArrayList<String>) rowObj, csvStringBuilder);
