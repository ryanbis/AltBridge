...
public class TableLayout implements Layout {
   ...
   * @param context  view context
   */
  TableLayout(Context context, int numColumns, int numRows, int resourceId) {
    layoutManager = (android.widget.TableLayout) ((Activity)context).findViewById(resourceId);
    //this.numColumns = numColumns;
    //this.numRows = numRows;
