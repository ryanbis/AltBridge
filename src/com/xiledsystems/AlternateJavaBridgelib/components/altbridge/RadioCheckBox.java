...
public class RadioCheckBox extends AndroidViewComponent implements android.widget.CompoundButton.OnCheckedChangeListener,
	...
	private int textColor;
	  ...
	  public RadioCheckBox(ComponentContainer container, int resourceId) {
		    ...
		    view = null;
		    android.widget.RadioButton view = (android.widget.RadioButton) container.$form().findViewById(resourceId);
		    // Listen to focus changes
		    view.setOnFocusChangeListener(this);
		    view.setOnCheckedChangeListener(this);	      
		    getfontTypeFace();	    	    
	  ...
	  public View getView() {
		  if (resourceId!= -1) {
			  return (android.widget.RadioButton) container.$context().findViewById(resourceId);
		  } else {
			  return view;
		  }
	  }
	  ...
	  /**
	   * Specifies the radio checkbox's background color as an alpha-red-green-blue
	   * integer.
	   *
	  ...
	  public void BackgroundColor(int argb) {
	    ...
	    if (argb != Component.COLOR_DEFAULT) {
	    	if (resourceId!= -1) {
	    		TextViewUtil.setBackgroundColor((android.widget.RadioButton) container.$context().findViewById(resourceId), argb);
	    	} else {
	    		TextViewUtil.setBackgroundColor(view, argb);
	    	}
	    } else {
	    	if (resourceId!= -1) {
	    		TextViewUtil.setBackgroundColor((android.widget.RadioButton) container.$context().findViewById(resourceId), Component.COLOR_NONE);
	    	} else {
	  ...
	  public void Enabled(boolean enabled) {
		  if (resourceId!= -1) {
			  TextViewUtil.setEnabled((android.widget.RadioButton) container.$context().findViewById(resourceId), enabled);
		  } else {
	  ...
	  /**
	   * Returns true if the radio checkbox's text should be bold.
	  ...
	  /**
	   * Specifies whether the radio checkbox's text should be bold.
	  ...
	  public void FontBold(boolean bold) {
	    this.bold = bold;
	    if (resourceId != -1) {
	    	TextViewUtil.setFontTypeface((android.widget.RadioButton) container.$context().findViewById(resourceId), fontTypeface, bold, italic);
	    } else {
	    	TextViewUtil.setFontTypeface(view, fontTypeface, bold, italic);
	    }
	  }
	  ...
	  /**
	   * Returns true if the radio checkbox's text should be italic.
	  ...
	  /**
	   * Specifies whether the radio checkbox's text should be italic.
	  ...
	  public float FontSize() {
		  if (resourceId!=-1) {
			  return TextViewUtil.getFontSize((android.widget.RadioButton) container.$context().findViewById(resourceId));
		  } else {
	  ...
	  public void FontSize(float size) {
		  if (resourceId!=-1) {
			  TextViewUtil.setFontSize((android.widget.RadioButton) container.$context().findViewById(resourceId), size);
		  } else {
	  ...
	  public String Text() {
		  if (resourceId!=-1) {
			  return TextViewUtil.getText((android.widget.RadioButton) container.$context().findViewById(resourceId));
		  } else {
	   ...
	   *
	   * @param text  new caption for radio checkbox
	   */
	  
	  public void Text(String text) {
		  if (resourceId!=-1) {
			  TextViewUtil.setText((android.widget.RadioButton) container.$context().findViewById(resourceId), text);
		  } else {
	  ...
	  public void TextColor(int argb) {
	    ...
	    if (argb != Component.COLOR_DEFAULT) {
	    	if (resourceId!=-1) {
	    		TextViewUtil.setTextColor((android.widget.RadioButton) container.$context().findViewById(resourceId), argb);
	    	} else {
	    		TextViewUtil.setTextColor(view, argb);
	    	}
	    } else {
	    	if (resourceId!=-1) {
	    		TextViewUtil.setTextColor((android.widget.RadioButton) container.$context().findViewById(resourceId), Component.COLOR_BLACK);
	    	} else {
	  ...
	  public boolean Checked() {
		  if (resourceId!=-1) {
			  return ((android.widget.RadioButton) container.$context().findViewById(resourceId)).isChecked();
		  } else {
	  ...
	  public void Checked(boolean value) {
		  if (resourceId!=-1) {
			  ((android.widget.RadioButton) container.$context().findViewById(resourceId)).setChecked(value);
			  ((android.widget.RadioButton) container.$context().findViewById(resourceId)).invalidate();
		  } else {
