...
public class Pedometer extends AndroidNonvisibleComponent
  ...
  public Pedometer(ComponentContainer container) {
    ...
    locationManager = (LocationManager) container.$context().getSystemService(Context.LOCATION_SERVICE);
    locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 0, 0, this);

    // Restore preferences
    SharedPreferences settings = container.$context().getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);
